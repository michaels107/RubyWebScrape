...
# Brings the two OSU job scrapings under a single umbrella where a range of functions may be performed
require_relative '../web_scraping/student_job_search'
require_relative '../web_scraping/job'
require 'mail'
...
class CombinedSearches
  ...
  def email(receiver_id, file_name)
    ...
    mail = Mail.new do
      ...
      add_file File.realpath("saved_data/#{file_name}").to_s # path to the file
